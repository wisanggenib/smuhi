        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Slider Utama</h3>
...
<?php
$id_slider_lama = $_GET['id_slider'];
 if (isset($_POST['save'])){
 $fileName = $_FILES['gambar']['name'];
  // Simpan di Folder Gambar
  move_uploaded_file($_FILES['gambar']['tmp_name'], "../img/".$_FILES['gambar']['name']);

$sql = "UPDATE slider_utama SET gambar = '$fileName' WHERE id_slider = $id_slider_lama;";

if ($config->query($sql) === TRUE) {
    ?>
<meta http-equiv="refresh" content="0;URL=slider_utama.php" />
    <?php
} else {
