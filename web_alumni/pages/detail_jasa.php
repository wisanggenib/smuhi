	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-center">
          ...
          ALUMNI MUHI
				...
				<p class="text-white link-nav"><a href="index.php?page=dashboard">Home </a>  <span class="lnr lnr-arrow-right"></span> Penawaran Jasa </p>
			</div>
		</div>
	</div>
</section>
  ...
  <div class="container">
      <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-8 posts-list">
            <div align="center">
              <h1>PENAWARAN JASA <br> ALUMNI MUHI</h1>
            </div>
            <br><br>
            <div class="desc-wrap" align="left">
              ...
              <?php
                ...
                $id = $_GET['id'];
                $sql = mysqli_query($config, "SELECT * FROM tbl_jasa WHERE id_jasa = $id");
                while($loker = mysqli_fetch_array($sql)){
                  ?>
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row">
                      <div class="col-lg-4 col-md-4 col-sm-4">
                        <img src="img/jasa/<?=$loker['logo']?>" width = "150px" alt="" style="border-radius : 10px;">
                      </div>
              ...
              <div class="" align="center">
                <button type="submit" name="previous" class="btn btn-warning"><i class="fa  fa-chevron-left"></i> Sebelumnya</button>
                <button type="submit" name="previous" class="btn btn-warning"><i class="fa  fa-chevron-right"></i> Selanjutnya</button>
              </div>
