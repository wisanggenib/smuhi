	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-center">
          ...
          ALUMNI MUHI
				...
				<p class="text-white link-nav"><a href="index.php?page=dashboard">Home </a>  <span class="lnr lnr-arrow-right"></span> Kartu Alumni </p>
			</div>
		</div>
	</div>
</section>
  ...
  <div class="container">
    <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-8 posts-list">
            <div align="center">
              <h1>REGISTRASI KARTU <br> ALUMNI MUHI</h1>
            </div>
          </div>
