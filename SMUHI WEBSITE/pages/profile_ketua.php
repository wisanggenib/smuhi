	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content col-lg-12">
				<h1 class="text-white">
					<span style="font-family: Montserrat-Light">PROFIL KETUA ALUMNI</span> <span style="font-family: Montserrat-Bold">MUHI</span>
          <br>
          <span style="font-family: Lora-BoldItalic">Bpk. Anto Nio</span>
				</h1>
  ...
  <div class="container">
    <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-8 posts-list">
            <div align="left">
              <h1><span style="font-family: Montserrat-Light">PROFIL KETUA ALUMNI</span> <span style="font-family: Montserrat-Bold">MUHI</span></h1>
            </div>
            <?php
