          ...
          <div class="col-lg-8 col-md-8 col-sm-8 posts-list">
            ...
            <div class="desc-wrap" align="left">
              ...
              <?php
                ...
                $result1 = mysqli_query($config,"SELECT * FROM tbl_jasa");
                $total = mysqli_num_rows($result1);
                $pages = ceil($total/$halaman);
                $sql = mysqli_query($config,"SELECT * FROM tbl_jasa ORDER BY tanggal DESC LIMIT $mulai, $halaman");
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                      <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                          <img src="img/jasa/<?=$loker['logo']?>" width = "175px" alt="" style="border-radius : 10px;">
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8">
                          <ul>
                            <li>
                              <a href="index.php?page=detail_jasa&&id=<?=$loker['id_jasa']?>">
