    ...
    while($slider = mysqli_fetch_array($sql)){
      if ($i==1) {
        ...
        <div class="carousel-item active">
          <section class="relative" id="home" style=" background: url(img/<?=$slider['gambar']?>) right;background-size: cover;">
            <div class="overlay overlay-bg" style="background-color: rgba(84, 89, 92, 0.8)"></div>
            <div class="container-fluid">
              <div class="row fullscreen d-flex align-items-center justify-content-between">
                <div class="banner-content col-lg-9 col-md-12" style="line-height: 35px">
                  <p class="" align="right">
                    <span style="font-family: Montserrat-Light;font-size: 50px;color: white">Selamat Datang</span><br>
                    <span style="font-family: Montserrat-Bold;font-size: 50px;color: white">Alumni SMA 1 Muhammadiyah</span><br>
                    <span style="font-family: Montserrat-Light;font-size: 50px;color: white ">Yogyakarta</span>
                  </p>
                  <p align="right" style="color: white;line-height: 25px;font-size: 16px;font-family: Lora-Italic;letter-spacing: 1px;">
      ...
      <div class="menu-content pb-70 col-lg-8">
        <div class="title text-center">
          <a href="index.php?page=berita">
            <h1 class="mb-10"><span style="color: #2E56A0;font-family: Montserrat-Bold">BERITA TERBARU</span></h1>
          </a>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6">            
            ...
            $sql = mysqli_query($config, "SELECT * FROM tbl_berita INNER JOIN tbl_admin ON tbl_berita.id_admin = tbl_admin.id_admin WHERE status='terima' and bintang='bintang' ORDER BY tbl_berita.id_berita DESC LIMIT 1 ");
...
<?php 
 ...
 <?php
        ...
        $sql = mysqli_query($config, "SELECT * FROM tbl_beritaalumni ORDER BY tbl_beritaalumni.id_beritaalumni DESC LIMIT 3");
        while($beritaalumni = mysqli_fetch_array($sql)){
          ...
          <div class="col-lg-4 each-feature" >
            <div class="col-md-12 col-lg-12" style="background: url(img/berita/<?=$beritaalumni['img']?>) center; height: 260px;">
              <div class="row">
                <div class="col-md-4" style="background-color: white; padding: 5px;text-align: center; margin-top: 3%;"><?=$beritaalumni['tempat']?></div>
              </div>
