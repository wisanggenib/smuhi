              ...
              <form role="form">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="judul" class="form-control" id="exampleInputEmail1" placeholder="Masukan Judul" value="<?=$berita['judul_berita']?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal</label>
                    <input type="date" class="form-control" id="exampleInputPassword1" placeholder="tanggal" value="<?=$berita['tanggal']?>">
                  </div>
<!--                   <div class="form-group">
                ...
                <div class="card-footer">
                  <a href="terima.php?id_berita=<?=$id_berita?>"><button class="btn btn-primary"><i class="fas fa-check"></i> Terima</button></a>
                  <a href="hapus.php?id_berita=<?=$id_berita?>"><button class="btn btn-danger"><i class="fas fa-eraser"></i> Tolak</button></a>
                </div>
