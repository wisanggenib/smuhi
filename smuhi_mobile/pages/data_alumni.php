	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content col-lg-12" style="top: -80px;">
				<h1 class="text-white">
					<span style="font-family: Montserrat-Light; font-size: 20px;">DATA ALUMNI</span> <span style="font-family: Montserrat-Bold; font-size: 20px;">MUHI</span>
          <br>
          <span style="font-family: Lora-BoldItalic; font-size: 20px;">1956-<script>document.write(new Date().getFullYear());</script></span>
				</h1>
				<p class="text-white link-nav" style="font-size: 12px;"><a href="index.php?page=dashboard">Home </a>  <span class="lnr lnr-arrow-right"></span> Data Alumni</p>
			</div>
		</div>
	</div>
</section>
