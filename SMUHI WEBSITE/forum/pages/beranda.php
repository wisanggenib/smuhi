                ...
                <div class="row">
                    ...
                    <div align="right" class="col-lg-2" style="margin-top : 25px;">
                        ...
                        <img src="img/icon/iconfinder_26.browser-website_4201264.svg" alt="" width="20px;"> 
                                ...
                                <?php
                $sql = mysqli_query($config,"SELECT * FROM tbl_thread join tbl_alumni ON tbl_thread.id_alumni = tbl_alumni.id_alumni JOIN tbl_kategori ON tbl_thread.id_kategori = tbl_kategori.id_kategori ORDER BY tbl_thread.id_thread DESC");
                while($data = mysqli_fetch_array($sql)){
                    ?>
