            ...
            <div class="col-lg-6 col-md-6 col-sm-6 posts-list">
                <div class="row">
                    ...
                    <div align="right" class="col-lg-2" style="margin-top : 25px;">
                        ...
                        <img src="img/icon/iconfinder_26.browser-website_4201264.svg" alt="" width="20px;">
                                ...
                                <?php
                $sql = mysqli_query($config,"SELECT * FROM tbl_thread join tbl_alumni ON tbl_thread.id_alumni = tbl_alumni.id_alumni JOIN tbl_kategori ON tbl_thread.id_kategori = tbl_kategori.id_kategori WHERE tbl_thread.id_kategori = $_GET[id_kategori] ORDER BY tbl_thread.id_thread DESC");
                while($data = mysqli_fetch_array($sql)){
                    ?>
                <div class="row" style="margin-top : 15px;">
                    ...
                    <a href="index.php?page=artikel&&id_thread=<?php echo $data['id_thread'] ?>" style="color:black; width: 100%;">
                        <img src="img/thread/<?php echo $data['gambar']; ?>" alt="" width="100%" style="margin-bottom : 15px;">
