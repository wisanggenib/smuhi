      ...
      <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-8 posts-list">
            <?php
              ...
              $id = $_GET['id'];
              $sql = mysqli_query($config, "SELECT * FROM tbl_beritaalumni WHERE tbl_beritaalumni.id_beritaalumni = $id");
              while($berita = mysqli_fetch_array($sql))
              {
                ?>
                  <h3 style="margin : 10px;"><?=$berita['judul']?></h3>
                  <div class="" style="margin : 10px;">
                    <i class="fa fa-calendar"> <?=$berita['tanggal']?></i>
                    <!-- <i class="fa fa-user"> <?=$berita['username']?></i> -->
                  </div>
                  <img src="img/berita/<?=$berita['img']?>" alt="" width="100%" style="margin-bottom : 15px;">
                  <p>
                    <?=$berita['deskripsi']?>
                  </p>
            ...
            <div class="comentar" style="margin-top : 40px;">
              ...
              <div class="form-comentar" style="margin : 10px;">
                ...
                <div class="col-lg-12 col-md-12">
                  <div class="comments-area" style="background-color: white; border-color: white; margin-top: 20px;">
                  <?php
                    $id = $_GET['id'];
                    ...
                    while($data = mysqli_fetch_array($sql)){
                      ...
                      ?>
                        ...
                        <div class="comment-list" style="background-color: hsla(0, 100%, 90%, 0.3);; margin-bottom: 20px; padding: 10px">
