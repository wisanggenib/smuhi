	...
	<div class="container">
		<div class="row d-flex align-items-center justify-content-center">
			<div class="about-content col-lg-12" style="top : -75px;">
				<h1 class="text-white">
					<span style="font-family: Montserrat-Light; font-size: 20px;">STRUKTUR ORGANISASI
          <br>
          ALUMNI</span> <span style="font-family: Montserrat-Bold; font-size: 20px;">MUHI</span>
				</h1>
				<p class="text-white link-nav" style="font-size: 12px;"><a href="index.php?page=dashboard">Home </a>  <span class="lnr lnr-arrow-right"></span> Tentang Kami <span class="lnr lnr-arrow-right"></span> Struktur Organisasi Alumni MUHI </p>
			</div>
		</div>
	</div>
</section>
  ...
  <div class="container">
    <div class="row">
          <div class="col-lg-8 col-md-8 col-sm-8 posts-list">
            <div align="center">
              <h4><span style="font-family: Montserrat-Light">STRUKTUR ORGANISASI <br> ALUMNI</span> <span style="font-family: Montserrat-Bold">MUHI</span></h4>
            </div>
          </div>
