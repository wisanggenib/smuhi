            ...
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <img src="../img/112.jpg" alt="" style="width: 200px; height: 200px; border-radius : 100%; border-style: solid; border-color: white; position : absolute ; top : -200px;">                        
                    </div>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <h1 class="text-white" style="position : absolute ; top : -150px; margin-left: 50px;">Bagus Sekali</h1>
                    </div>
                </div>        
            </div>
            <div class="col-lg-6 col-md-6">
                <a href="" class="btn btn-success" style="position: absolute; top: -150px; left: 200px;"><i class="fa fa-camera fa-2x"></i> Upload Cover Images</a>
            </div>
        </div>
