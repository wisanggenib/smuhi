            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 posts-list">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                <input type="text" class="form-control" value="https://amikom.ac.id" style="position: relative ; top : -5px;" readonly>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                ...
                <div class="row" style="margin-top : 15px;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem maxime quae, quibusdam non sunt nulla laboriosam et veritatis eveniet voluptatum inventore! Accusantium enim vel magnam corrupti? Adipis
                            ci assumenda excepturi sint? Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto dicta quos doloribus necessitatibus labore ipsa inventore, ipsam natus cumque quaerat expedita alias cum unde, facere, veritatis distinctio eius quis in!
                            <br><br>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem maxime quae, quibusdam non sunt nulla laboriosam et veritatis eveniet voluptatum inventore! Accusantium enim vel magnam corrupti? Adipis
                            ci assumenda excepturi sint? Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto dicta quos doloribus necessitatibus labore ipsa inventore, ipsam natus cumque quaerat expedita alias cum unde, facere, veritatis distinctio eius quis in!
                        </p>   
                        <blockquote>
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto exercitationem doloremque quidem deserunt, aliquam placeat quaerat blanditiis repellendus! Vero praesentium impedit, eligendi odio non quia dolor assumenda aut dolorum magnam.
                            </p>
                        </blockquote>
                        <hr size="15px" width="100%">                                               
                    </div>
