...
<section class="popular-course-area single-post-area" style="margin-left: 10px; margin-right: 10px; ">
    <div class="container">
        <div class="row">
        ...
        <div class="row" style="position : relative;top : -100px;">           
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 posts-list">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 col-3">
                        <a href="" style="color : gray;">
                            <i class="fa fa-share-alt"> 29</i>
                        </a>
                    </div>

                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-5">
                        <a href="" style="color : gray;"><i class="fa fa-facebook"></i></a>
                        <a href="" style="color : gray;"><i class="fa fa-instagram" style="margin-left:5px;"></i></a>
                        <a href="" style="color : gray;"><i class="fa fa-whatsapp" style="margin-left: 5px;"></i></a>
                        <a href="" style="color : gray;"><i class="fa fa-twitter" style="margin-left: 5px;"></i></a>
                        <a href="" style="color : gray;"><i class="fa fa-envelope" style="margin-left: 5px;"></i></a>
                    </div><!-- 
                ...
                <div class="row" style="margin-top : 15px;">
                    ...
                    <hr size="15px" width="100%">
                    <img src="img/thread/<?php echo $data_detail_artikel['gambar'] ?>" alt="" width="90%" style="margin : 15px;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6" align="right">
                        <i class="fa fa-wechat" style="margin-right: 20px;"> Kutip</i>
                ...
                <div class="row" style="margin-top : 20px;">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" style ="margin-bottom : 20px;">
                        ...
                        <div style="">
                            <div>
                                <h5 style="float:left; ">Mark Allen</h5>
                                <i style="margin-left : 5px; position : relative;">10 Agustus 2019 | 10:45</i>
                            </div>
                            <br>
                            <div style="position : relative ; top: -15px;">
                                <span>Spotlight</span>
